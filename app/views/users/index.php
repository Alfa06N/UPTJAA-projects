...
<body>
    ...
    <div class="main-container container-fluid d-flex">
        ...
        <div class="page_content col-6 col-sm-6 col-md-6  d-flex flex-column justify-content-center align-items-center text-center ">
            <h1 class="title ">ListPersons</h1>
            <h2 class="subtitle">¡Crea tu lista de personas!</h2> 
            <button type="button" class="btn btn-lg "> <a class="Link fs" href="#">Haz Click Aquí</a> </button> 
        </div>
